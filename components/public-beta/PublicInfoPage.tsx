  ...
  return <PublicBetaShell language={language} setLanguage={setLanguage} service="ChallanSakshi" serviceHindi="डेस्कटॉप सहायता">
    <main className={styles.infoPage}>
      ...
      <InfoSection title={t(language, 'Retention, recovery, and protected fields', 'अवधि, पुनर्प्राप्ति और सुरक्षित फ़ील्ड')}>
        ...
        <p>{t(language, 'A payload-free local replay is available only until effective expiry. A partial, indeterminate, or late result remains needs-review until affected-person acknowledgement or 24 hours, whichever comes first.', 'पेलोड-रहित स्थानीय replay केवल प्रभावी समाप्ति तक उपलब्ध रहता है। आंशिक, अनिर्णायक या देर से आया परिणाम प्रभावित-व्यक्ति की पावती या चौबीस घंटे, जो पहले हो, तक needs-review रहता है।')}</p>
        <p>{t(language, 'Any unresolved or orphaned records have no automatic time-based clearing. Device-owner recovery is possible only after all relevant official tabs and browser processes are closed and reopened.', 'Unresolved या orphaned रिकॉर्ड की कोई स्वचालित समय-आधारित सफ़ाई नहीं होती। डिवाइस-मालिक पुनर्प्राप्ति तभी कर सकता है जब सभी संबंधित आधिकारिक टैब और ब्राउज़र प्रक्रियाएँ बंद करके फिर खोली जाएँ।')}</p>
