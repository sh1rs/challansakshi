// Generated by scripts/build-voice-worker.mjs. Edit the TypeScript source.
...
self.onmessage = async (event) => {
    ...
    if (request.type === 'load') {
        try {
            ...
            const { env, pipeline } = await import(/* @vite-ignore */ runtimeUrl);
            if (env.version !== '3.8.1')
                throw new Error('Unexpected local runtime version');
